...
class Event(models.Model):
    ...
    CATEGORY_CHOICES = [
        ("tech_workshop", "Technical Workshop"),
        ("hackathon", "Hackathon"),
    ...
    def registration_status(self):
        ...
        if (
            ...
            and self.registration_deadline < timezone.localdate()
        ):
            return "closed"
    ...
    **kwargs
    ...
    if created and not instance.registration_id:
        ...
        instance.registration_id = (
            f"ECO-{instance.created_at.year}-{instance.pk:06d}"
        )
    ...
    **kwargs
    ...
    if created and not instance.certificate_id:
        ...
        instance.certificate_id = (
            f"ECO-CERT-{instance.issued_on.year}-{instance.pk:05d}"
        )
