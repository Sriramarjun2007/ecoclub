    ...
    <div className="pt-28 min-h-[80vh] flex items-center justify-center px-4">
      <div className="glass rounded-3xl p-8 w-full max-w-md">
        ...
        <div className="text-center mb-6">
          ...
          <div className="w-14 h-14 mx-auto rounded-full bg-emerald-600 text-white grid place-items-center text-2xl mb-3">
            🌿
          </div>
          ...
          <p className="text-sm text-forest-600 mt-1">
            Login to your ECO CLUB account
          </p>
        ...
        >
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 rounded-lg bg-emerald-600 text-white font-bold hover:bg-emerald-700 disabled:opacity-60"
          >
            {loading
              ? 'Logging in…'
              : 'Login'}
        ...
        <div className="mt-5 text-center text-sm text-forest-600 space-y-1">
          ...
          <p>
            ...
            Contact the coordinator to reset.
          </p>
